  ...
  pages: [
    {
      ...
      href: "#/",
      status: "published",
      seoTitle: "대광테크 기업 홈페이지 | DAEKWANG TECH",
  ...
  posts: [
    {
      ...
      summary: "공정별 품질 확인 기준을 정리하는 관리자 초안입니다.",
      body: "관리자 페이지에서 작성한 게시글은 현재 브라우저 초안으로 저장됩니다. 공개 배포에는 JSON export 후 빌드 반영이 필요합니다.",
