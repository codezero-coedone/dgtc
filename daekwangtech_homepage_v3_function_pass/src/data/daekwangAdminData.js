export const publicImageSlots = [
  {
    key: "homeHeroImage",
    label: "홈 대표 이미지",
    publicSection: "홈 메인 히어로",
    description: "홈 첫 화면과 모바일 첫 대표 이미지에 노출됩니다.",
    fallback: "assets/real-hero-batch-components.jpg",
  },
  {
    key: "processHeroImage",
    label: "공정 대표 이미지",
    publicSection: "제조 프로세스 히어로 / 공정 증빙 카드",
    description: "공정 페이지 대표 이미지와 홈 공정 증빙 영역에 연결됩니다.",
    fallback: "assets/real-process-shaft-detail.jpg",
  },
  {
    key: "qualityVisualImage",
    label: "품질 대표 이미지",
    publicSection: "품질 관리 히어로 / 품질 카드",
    description: "품질 관리 페이지와 품질 섹션의 첫 시각 자료에 연결됩니다.",
    fallback: "assets/real-precision-threaded-pair.jpg",
  },
  {
    key: "facilityVisualImage",
    label: "설비 대표 이미지",
    publicSection: "설비/시설 히어로 / 설비 카드",
    description: "설비 페이지와 설비 섹션의 첫 시각 자료에 연결됩니다.",
    fallback: "assets/real-hero-batch-components.jpg",
  },
  {
    key: "productsGalleryImages",
    label: "제품 갤러리 이미지",
    publicSection: "제품/서비스 카드 갤러리",
    description: "제품/서비스 카드 이미지에 노출 순서대로 연결됩니다.",
    fallback: "assets/real-black-valve-core.jpg",
  },
];

export const categoryLabels = Object.fromEntries(publicImageSlots.map((slot) => [slot.key, slot.label]));

export const retiredAdminSectionKeys = ["pages", "popups", "footer", "seo", "users"];

export function normalizeAdminSectionKey(key) {
  return adminSectionOptions.some((section) => section.key === key) ? key : "dashboard";
}
...
export const imageAssets = [
  {
    id: "banner-01",
    category: "homeHeroImage",
    title: "홈 대표 이미지",
    fileName: "real-hero-batch-components.jpg",
    fileSize: "2.4MB",
    resolution: "1920 x 800",
    uploadDate: "2024-05-20",
    status: "active",
    imageUrl: "assets/real-hero-batch-components.jpg",
    order: 1,
  },
  {
    id: "banner-02",
    category: "processHeroImage",
    title: "공정 대표 이미지",
    ...
    status: "active",
    imageUrl: "assets/real-process-shaft-detail.jpg",
    order: 2,
  },
  {
    id: "banner-03",
    category: "qualityVisualImage",
    title: "품질 대표 이미지",
    ...
    status: "active",
    imageUrl: "assets/real-precision-threaded-pair.jpg",
    order: 3,
  },
  {
    id: "banner-04",
    category: "facilityVisualImage",
    title: "설비 대표 이미지",
  ...
  {
    id: "company-01",
    category: "productsGalleryImages",
    title: "제품 갤러리 01",
    ...
    status: "active",
    imageUrl: "assets/real-black-valve-core.jpg",
    order: 1,
  },
  {
    id: "facility-01",
    ...
    status: "active",
    imageUrl: "assets/real-silver-valve-core.jpg",
    order: 1,
  },
  {
    id: "product-01",
    ...
    status: "active",
    imageUrl: "assets/real-stepped-shaft-vertical.jpg",
    order: 3,
  },
];
