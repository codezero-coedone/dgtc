...
export const pageContent = {
  ...
  technology: {
    ...
    cards: [
      ["고정밀 CNC 가공", "정밀한 치수와 표면 품질을 요구하는 부품 대응", "assets/product-1.jpg"],
      ["복합 형상 대응", "복잡한 형상의 부품과 지그, 장비 부품 제작", "assets/product-3.jpg"],
      ["소재별 가공 조건", "알루미늄, 스틸 등 소재 조건에 맞춘 공정 검토", "assets/blueprint-ghost.jpg"],
      ["공차 관리", "측정과 검증을 통한 안정적인 품질 확보", "assets/inspection-cmm.jpg"],
    ],
  ...
  products: {
    ...
    cards: [
      ["정밀 가공 부품", "고정밀 CNC 가공으로 완성하는 복잡 형상 부품", "assets/product-1.jpg"],
      ["금속 처리", "표면 처리 및 열처리 기술로 내구성과 품질 향상", "assets/product-2.jpg"],
      ["지그 & 장비 부품", "생산성과 정밀도를 높이는 맞춤형 지그 및 부품", "assets/product-3.jpg"],
      ["프로토타입 & 소량 생산", "신속한 제작과 유연한 대응으로 고객 개발 단계 지원", "assets/product-4.jpg"],
      ["조립 & 모듈", "가공부터 조립까지 원스톱 솔루션 제공", "assets/product-5.jpg"],
    ],
  ...
  quality: {
    ...
    cards: [
      ["3차원 측정기 (CMM)", "정밀 치수 및 형상 측정", "assets/inspection-cmm.jpg"],
      ["형상 측정기", "고정밀 형상 및 공차 검사", "assets/inspection-profile.jpg"],
      ["표면 거칠기 측정기", "표면 품질 및 가공기 분석", "assets/inspection-surface.jpg"],
      ["경도 시험기", "소재 경도 및 열처리 상태 평가", "assets/inspection-hardness.jpg"],
    ],
  ...
  facility: {
    ...
    cards: [
      ["정밀 가공 설비", "고정밀 CNC / 복합 가공기", "assets/facility-cnc.jpg"],
      ["자동화 시스템", "로봇 자동화 및 무인 운영 시스템", "assets/facility-auto.jpg"],
      ["측정 & 검사실", "전용 측정실 및 항온·항습 관리", "assets/facility-lab.jpg"],
      ["클린 생산 환경", "청정하고 체계적인 생산 환경", "assets/facility-clean.jpg"],
      ["물류 & 보관 시스템", "체계적인 자재 및 제품 관리", "assets/facility-logistics.jpg"],
    ],
  ...
  company: {
    ...
    cards: [
      ["신뢰", "정직과 책임을 바탕으로 고객의 신뢰를 지켜갑니다.", "assets/product-1.jpg"],
      ["정밀", "마이크로 단위의 정밀함으로 최고의 품질을 만듭니다.", "assets/inspection-cmm.jpg"],
      ["혁신", "지속적인 기술 혁신으로 미래를 선도합니다.", "assets/facility-lab.jpg"],
      ["상생", "고객, 협력사와 함께 지속 가능한 성장을 추구합니다.", "assets/facility-auto.jpg"],
    ],
